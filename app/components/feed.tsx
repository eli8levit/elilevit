    ...
    <FaidInMotionContainer className="content-container mb-14 pb-4 pt-6">
      <div className="relative rounded-2xl border-[0.5px] border-black border-opacity-10 bg-[rgba(0,0,255,0.02)] p-6 backdrop-blur-2xl md:p-20">
        <div className="mb-6 flex flex-row items-center gap-x-4 opacity-30 md:mb-14">
          <h3
            id="latest-stuff"
            className=" flex flex-row gap-x-4 font-mona text-xl font-semibold text-black md:text-4xl"
          >
            Latest stuff
          </h3>
          <Arrow className="h-[18px] rotate-90" />
        </div>
        <div className="flex flex-col gap-20">
          <div>
            <p className="font-hubot text-sm font-bold text-black md:text-base">
              21.4.2023
            </p>
            <div className="mb-4 flex flex-wrap items-center justify-between md:flex-row">
              <p className="mr-4 flex w-max flex-row flex-wrap items-center gap-x-2 fill-zinc-600 font-mona text-base font-light text-zinc-600 md:text-xl">
                <svg
                  version="1.1"
            ...
            <div className="grid grid-cols-1 gap-2 md:grid-cols-[3fr_2fr_2fr_3fr]">
              <img
                src={genImageUrlById("021cd876-f163-4095-8a8b-ad6f3eb19f4a")}
                height="45vh"
                className="h-[200px] max-h-[600px] min-h-[200px] w-full rounded-md object-cover shadow-lg md:h-[380px] 2xl:h-[450px]"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-2 md:grid-cols-[6fr_4fr]">
              <img
