      ...
      {params?.postId && (
        <>
          <motion.div className="overflow-hidden">
            <motion.div
              className="fixed left-0 right-0 top-0 z-20 mx-auto h-full max-h-[1500px] w-full overflow-auto bg-[rgba(255,243,244,0.9)] pb-6 shadow-2xl backdrop-blur-xl md:top-[2vh] md:h-[96vh] md:w-[50vw] md:min-w-[650px] md:max-w-[900px] md:rounded-2xl md:rounded-t-2xl md:pb-0"
