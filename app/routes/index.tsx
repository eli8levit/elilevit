    ...
    <>
      <div className="bg-indexBg bg-cover bg-center bg-no-repeat">
        <div className="content-container">
          <h1 className="mb-24 h-[120px] font-butler text-8xl font-semibold text-primaryText">
            Hey, good to see you!
          </h1>
      ...
      <section className="mb-48 w-full bg-blueNoise shadow-xl">
        <div className="content-container ">
          ...
          <ul className="mx-auto grid max-w-[2000px] grid-cols-2 items-end gap-10 text-xl">
            ...
            <li>
              ...
              >
                <span className="mt-auto mr-2 mb-2 ml-2 rounded-md bg-labelBg bg-cover bg-bottom bg-top bg-no-repeat p-1 font-sligoil text-sm text-white transition group-hover:bg-casualBlue group-hover:text-blueLight 2xl:text-lg">
                  Know me better
                </span>
              </Link>
            </li>
