  ...
  return (
    <>
      ...
      <main className="content-container ">
        <h1 className="mb-24 font-satisfy text-8xl text-indigo-800">
        ...
        <div className="mx-auto mb-24 flex flex-row items-center gap-x-24">
          ...
          <div>
            <p className="p-8 font-apfel text-2xl text-primaryText">
            ...
            <p className="px-8 font-ignazio text-lg text-gray-700">
              <i>
                Thanks for{" "}
                <a
                  target="blank"
