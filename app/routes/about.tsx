  ...
  return (
    <main className="content-container mb-32 grid items-center gap-16 md:grid-cols-[2fr_3fr] md:grid-rows-[auto_100%]">
      ...
      <p className="mb-4 font-apfel text-xl text-black md:mr-auto md:text-2xl">
        ...
        you'll find a mix of art, design, coding, and more. Some of my passions
        include biking, music, and photography (all of the photos you see here
        are taken by me). I also enjoy sharing my personal biking and lifestyle
        blog with readers. Feel free to browse and explore my art and projects.
        If you have any questions or just want to connect, don't hesitate to
        reach out. Thanks for visiting!
        <i>
          Thanks for{" "}
          <a
            target="blank"
