...
const FeedRow = ({ date, title, linkProps, children }: IFeedRow) => {
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-x-2 md:mb-1 md:flex-row md:gap-x-4">
        <p className="font-hubot text-base font-bold text-zinc-400">{date}</p>
        <Link
          to={linkProps.to}
      ...
      <p className="mb-4 flex flex-row items-center gap-x-2 fill-black font-monaWide text-base text-black md:text-xl">
        {title}
      </p>
      {children}
    </div>
